...
export async function registerAthleteDoc(input: {
  ...
  revalidatePath(`/portal/athletes/${input.athleteId}/documents`);
}
...
` +
            `გთხოვთ გადაამოწმოთ: gndsf.ge/portal/athletes/${a.id}/documents
...
export async function verifyAthleteDoc(formData: FormData) {
  ...
  if (!aiConfigured()) redirect(`/portal/athletes/${doc.athleteId}/documents?ai=off`);
  await runDocVerification(id);
  revalidatePath(`/portal/athletes/${doc.athleteId}/documents`);
  redirect(`/portal/athletes/${doc.athleteId}/documents?ai=done`);
}
...
export async function deleteAthleteDoc(formData: FormData) {
  ...
  revalidatePath(`/portal/athletes/${doc.athleteId}/documents`);
  redirect(`/portal/athletes/${doc.athleteId}/documents?ok=deleted`);
}
