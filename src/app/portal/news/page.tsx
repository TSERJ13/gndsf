          ...
          {news.map((n) => (
            <li key={n.id} className="flex items-center justify-between gap-3 px-4 py-3">
              <div className="min-w-0">
                <Link href={`/portal/news/${n.id}`} className="text-sm font-medium hover:underline">
                  {n.title}
                </Link>
        ...
        <form action={createNews} className="h-fit rounded-lg border border-neutral-200 bg-white p-5">
          ...
          <div className="mt-4 space-y-3">
            ...
            <div>
              ...
              <input id="publishedAtOverride" name="publishedAtOverride" type="datetime-local" className={input} />
            </div>
